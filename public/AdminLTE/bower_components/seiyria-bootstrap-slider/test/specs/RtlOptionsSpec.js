describe("RTL Tests", function() {
  ...
  describe("rtl slider tests", function() {
    ...
    it("slider use inversed left and right inline style", function() {
      ...
      var sliderTrackLowRight=$("#rtlSlider").siblings(".slider-rtl").children("div.slider-song").children("div.slider-song-low").css("right");
      var sliderSelectionRight=$("#rtlSlider").siblings(".slider-rtl").children("div.slider-song").children("div.slider-selection").css("right");
      var sliderTrackHighLeft=$("#rtlSlider").siblings(".slider-rtl").children("div.slider-song").children("div.slider-song-high").css("left");
